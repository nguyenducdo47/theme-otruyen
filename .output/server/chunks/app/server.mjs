import { hasInjectionContext, getCurrentInstance, toRef, isRef, inject, unref, version, defineAsyncComponent, useSSRContext, ref, watchEffect, watch, defineComponent, withCtx, createVNode, createApp, reactive, computed, h, Suspense, nextTick, Transition, provide, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, shallowRef, isReadonly, mergeProps, isShallow, isReactive, toRaw } from 'vue';
import { $fetch } from 'ofetch';
import { createHooks } from 'hookable';
import { getContext, executeAsync } from 'unctx';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { createError as createError$1, sanitizeStatusCode } from 'h3';
import { withQuery, hasProtocol, parseURL, joinURL, withHttps } from 'ufo';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_slug_-631aa6e4.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-210f867c.mjs').then((m) => m.default || m)
  },
  {
    name: "lich-su",
    path: "/lich-su",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/lich-su-771d7b26.mjs').then((m) => m.default || m)
  },
  {
    name: "the-loai",
    path: "/the-loai",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/the-loai-dcf9155b.mjs').then((m) => m.default || m)
  },
  {
    name: "tim-kiem",
    path: "/tim-kiem",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/tim-kiem-690a1d95.mjs').then((m) => m.default || m)
  },
  {
    name: "top",
    path: "/top",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/top-8610f0a6.mjs').then((m) => m.default || m)
  },
  {
    name: "truyen-tranh-comicId-chapterId",
    path: "/truyen-tranh/:comicId()/:chapterId()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_chapterId_-b5a1793e.mjs').then((m) => m.default || m)
  },
  {
    name: "truyen-tranh-comicId",
    path: "/truyen-tranh/:comicId()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-beaf41ec.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-bf3b0694.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-25c21bf9.mjs').then((r) => r.default));
...
const layouts = {
  default: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/default-28ac64fd.mjs').then((m) => m.default || m))
};
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_NuxtErrorBoundary, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_NuxtLoadingIndicator),
              createVNode(_component_NuxtPage),
              createVNode(_component_NuxtErrorBoundary)
            ];
          }
        }),
        _: 1
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-67050725.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-2aa18960.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-f423a5e2.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { useRoute as a, useRouter as b, createError as c, useNuxtApp as d, entry$1 as default, useRequestFetch as e, useRuntimeConfig as f, useState as g, navigateTo as n, resolveUnrefHeadInput as r, useHead as u };
