declare global {
  const __buildAssetsURL: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nuxt/dist/core/runtime/nitro/paths')['buildAssetsURL']
  const __publicAssetsURL: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nuxt/dist/core/runtime/nitro/paths')['publicAssetsURL']
  ...
  const cachedEventHandler: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const createSitePathResolver: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nuxt-site-config/dist/runtime/nitro/composables/utils')['createSitePathResolver']
  const defaultContentType: typeof import('h3')['defaultContentType']
  const defineAppConfig: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nuxt/dist/core/runtime/nitro/config')['defineAppConfig']
  const defineCachedEventHandler: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const updateSiteConfig: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nuxt-site-config/dist/runtime/nitro/composables/updateSiteConfig')['updateSiteConfig']
  const useAppConfig: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nitropack/dist/runtime')['useAppConfig']
  const useBase: typeof import('h3')['useBase']
  const useNitroApp: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useNitroOrigin: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nuxt-site-config/dist/runtime/nitro/composables/useNitroOrigin')['useNitroOrigin']
  const useRuntimeConfig: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useSession: typeof import('h3')['useSession']
  const useSiteConfig: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nuxt-site-config/dist/runtime/nitro/composables/useSiteConfig')['useSiteConfig']
  const useStorage: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nitropack/dist/runtime')['useStorage']
  const withSiteTrailingSlash: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nuxt-site-config/dist/runtime/nitro/composables/utils')['withSiteTrailingSlash']
  const withSiteUrl: typeof import('D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nuxt-site-config/dist/runtime/nitro/composables/utils')['withSiteUrl']
  const writeEarlyHints: typeof import('h3')['writeEarlyHints']
}
export { defineCachedFunction, defineCachedEventHandler, cachedFunction, cachedEventHandler, useRuntimeConfig, useStorage, useNitroApp, defineNitroPlugin, nitroPlugin, defineRenderHandler, getRouteRules, useAppConfig } from 'D:/My-assets/otruyen_manga/theme-otruyen/node_modules/nitropack/dist/runtime';
