globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, getRequestHost, getRequestProtocol, getQuery as getQuery$1, setHeader, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, createError } from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/h3/dist/index.mjs';
import PDFDocument from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/pdfkit/js/pdfkit.js';
import { createRenderer } from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/devalue/index.js';
import { renderToString } from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/ofetch/dist/node.mjs';
import destr from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/scule/dist/index.mjs';
import { klona } from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withoutProtocol, withBase } from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/My-assets/otruyen_manga/theme-otruyen/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/My-assets/otruyen_manga/theme-otruyen/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\My-assets\\otruyen_manga\\theme-otruyen","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\My-assets\\otruyen_manga\\theme-otruyen\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\My-assets\\otruyen_manga\\theme-otruyen\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\My-assets\\otruyen_manga\\theme-otruyen\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
function useNitroOrigin(e) {
  ...
  let port = process.env.NITRO_PORT || process.env.PORT || (3e3 );
...
const _SpKF1r = defineEventHandler((e) => {
...
const _wrTXi7 = defineEventHandler(async (e) => {
  ...
  const siteUrl = withBase(useNitroOrigin(e) , useRuntimeConfig().app.baseURL);
  const queryIndexableEnabled = String(query.indexable) === "true" || query.indexable === "";
  const isIndexable = queryIndexableEnabled || indexable !== false;
...
const _cDz90l = defineEventHandler((e) => {
...
const _lazy_gx3lKR = () => Promise.resolve().then(function () { return alive_get$1; });
const _lazy_ry3XLw = () => Promise.resolve().then(function () { return download_get$1; });
const _lazy_O4HZS3 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/alive', handler: _lazy_gx3lKR, lazy: true, middleware: false, method: "get" },
  { route: '/download', handler: _lazy_ry3XLw, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_O4HZS3, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _SpKF1r, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _wrTXi7, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _cDz90l, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_O4HZS3, lazy: true, middleware: false, method: undefined }
];
...
const alive_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: alive_get
});

const download_get = defineEventHandler(async (event) => {
  const { chapterId, comicId } = getQuery$1(event);
...
const download_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const getClientManifest = () => import('file://D:/My-assets/otruyen_manga/theme-otruyen/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://D:/My-assets/otruyen_manga/theme-otruyen/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
